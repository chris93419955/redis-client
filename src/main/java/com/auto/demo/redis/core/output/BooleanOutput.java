...
/**
 * Boolean output. The actual value is returned as an integer where 0 indicates {@code false} and 1 indicates {@code true}, or
 * as a null bulk reply for script output.
 *
 * @param <K> Key type.
 * @param <V> Value type.
 * @author Will Glozer
